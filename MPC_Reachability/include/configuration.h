...
struct parameter_values
{
  ...
  double num_tolerance;              // By how much different a point should be to be considered different,
  ...
  parameter_values()
  {
    ...
    MILP_M = 1e10;
    MILP_tolerance = 5e-2;
    MILP_e_tolerance = 1e-15;
    epsilon_degeneracy = 1e-10;
    do_dynamic_M_computation = false;
